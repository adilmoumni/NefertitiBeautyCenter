...
<head>
	...
	<meta property="twitter:title" content="Contact | Nefertiti " />
					...
					<div class="container">
						...
						<section id="primary" class="page-with-sidebar with-right-sidebar">
							...
							<form action="submit.php" method="POST">
								...
								<div class="column dt-sc-one-half first">
									<p>Nom et Prénom </p>
									<input type="text" name="fullName" placeholder="Nom et Prénom " value="" required="">
								</div>


								<div class="column dt-sc-one-half">
									<p>Téléphone </p>
									<input type="text" name="phone" placeholder="06 xx xx xx xx " value="" required="">
								</div>

								<div class="column dt-sc-one-half first">
									<p>Email </p>
									<input type="email" placeholder="example@gmail.com " name="email" value="" required="">
								</div>

								<div class="column dt-sc-one-half half">
									<p>Message </p>
								...
								<!-- <div class="clear"></div> -->
								<div class="column dt-sc-one-half half" style="float: left;">
									<input class="btn btn-primary" value="Réserver" name="Réserver" type="submit" style="float: left;" />
								</div>
							</form>
							<!-- <input class="dt-sc-button small show-time" type="submit" value="Réserver" /> -->
							<!-- <p><a href="#" class="dt-sc-button small show-time">Réserver </a></p> -->
							<div class="hr-invisible-very-small"> </div>
							<div class="clear"> </div>
							<div class="available-times"></div>

							<div id="personalinfo" class="personal-info hidden">
								<h5 class="hr-title dark-title"><span>Personal Info</span></h5>
								<div class="hr-invisible-very-small"> </div>
								<div class="clear"> </div>
								...
								<div class="column dt-sc-one-half">
									<p><input type="email" name="email" value="" required placeholder="Email:"></p>
								</div>

								<div class="column dt-sc-one-half first">
									<p><input type="text" name="phone" value="" required placeholder="Phone:"></p>
								</div> -->
								...
								<!-- <div class="column dt-sc-one-half first">
									...
									<input type="hidden" name="hiddencaptcha" readonly="readonly" value="4371" />
								</div> -->
