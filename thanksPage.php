...
if ($con->connect_error) {
	die("Connexion Failed" . $con->connect_error);
		...
		$fullName = $phone = $email = $message = $service = $staff =$dateDispo = $startTime = $endTime ="";
		...
		if ($_SERVER["REQUEST_METHOD"] == "POST") {
			...
			$sqlAdd = "INSERT INTO reservation 
			(fullName , phone , email , message  , service , staff , dateDispo , startTime , endTime )
			VALUES 
			('$fullName' , '$phone' ,'$email', '$message' ,'$service' ,  '$staff' ,'$dateDispo', '$startTime', '$endTime')";
...
<!-- #post-5905 -->
<div id="post-5905" class="post-5905 page type-page status-publish hentry" style="margin:10%;">
<div class="dt-sc-hr-invisible  "></div>
<div class="dt-sc-clear"></div>
<div class="border-title ">
				  <h2>Merci pour votre visite</h2>
				  <div class="ico-border"> <i class="ico-bg flower"></i> </div>
				  <span class="tag-line">Write it on your heart</span>
				</div>
<div class="dt-sc-moving-bg " style="background-color:#5B3671;background-image:url(https://spalabdev.wpengine.com/wp-content/uploads/2015/11/scrolling-patnern.png);"><div class="dt-sc-moving-bg-content"><div class="container"><h2>Our Technological services has been improved vastly</h2>
<h6>Lorem ipsum dolor sit amet, consectetur adipisicing elit sed doeiusmod tempor incididunt ut labore etdolore magna aliqua Ut enim ad minim veniam doeiusmod tempor incididunt ut labore et dolore maga aliqua Ut enim ad minim veniam veniam doeiusmod tempor incididunt ut labore</h6></div></div></div>
<div class="dt-sc-hr-invisible  "></div>
<div class="dt-sc-clear"></div>
