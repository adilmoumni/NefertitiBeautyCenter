...
<head>
	...
	<link rel="canonical" href="https://spalabdev.wpengine.com/reservation/" />
	<meta property="og:site_name" content="spa lab | Just another WordPress site" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="Reservation | spa lab" />
	<meta property="og:url" content="https://spalabdev.wpengine.com/reservation/" />
	<meta property="article:published_time" content="2014-07-28T13:08:25Z" />
	<meta property="article:modified_time" content="2015-11-04T10:38:43Z" />
	<meta property="twitter:card" content="summary" />
	<meta property="twitter:domain" content="spalabdev.wpengine.com" />
	<meta property="twitter:title" content="Reservation | spa lab" />
	...
	<script type="application/ld+json" class="aioseo-schema">
		{
			...
			"@graph": [{
				...
				"@type": "BreadcrumbList",
				"@id": "https:\/\/spalabdev.wpengine.com\/reservation\/#breadcrumblist",
				"itemListElement": [{
					"@type": "ListItem",
					...
					"nextItem": "https:\/\/spalabdev.wpengine.com\/reservation\/#listItem"
				}, {
					"@type": "ListItem",
					"@id": "https:\/\/spalabdev.wpengine.com\/reservation\/#listItem",
					"position": 2,
					"item": {
						"@type": "WebPage",
						"@id": "https:\/\/spalabdev.wpengine.com\/reservation\/#item",
						"name": "Reservation",
						"url": "https:\/\/spalabdev.wpengine.com\/reservation\/"
					},
					"previousItem": "https:\/\/spalabdev.wpengine.com\/#listItem"
				}]
			}, {
				"@type": "WebPage",
				"@id": "https:\/\/spalabdev.wpengine.com\/reservation\/#webpage",
				"url": "https:\/\/spalabdev.wpengine.com\/reservation\/",
				"name": "Reservation | spa lab",
				"inLanguage": "en-US",
				"isPartOf": {
					"@id": "https:\/\/spalabdev.wpengine.com\/#website"
				},
				...
				"datePublished": "2014-07-28T13:08:25+00:00",
				"dateModified": "2015-11-04T10:38:43+00:00"
			}]
		}
	</script>
	<!-- All in One SEO -->
...
<![endif]-->
	...
	<link rel="alternate" type="application/json" href="https://spalabdev.wpengine.com/wp-json/wp/v2/pages/5" />
	...
	<link rel='shortlink' href='https://spalabdev.wpengine.com/?p=5' />
	<link rel="alternate" type="application/json+oembed" href="https://spalabdev.wpengine.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fspalabdev.wpengine.com%2Freservation%2F" />
	<link rel="alternate" type="text/xml+oembed" href="https://spalabdev.wpengine.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fspalabdev.wpengine.com%2Freservation%2F&#038;format=xml" />
	<noscript>
		<style>
...
<body class="page-template page-template-tpl-reservation page-template-tpl-reservation-php page page-id-5 woocommerce-no-js">
	<form action="thanksPage.php" method="post">
						...
						<div class="" style="padding-left: 10%; padding-right: 10%;">
							...
							<div id="primary-menu ">
								<nav id="main-menu">
									...
									<div class="row">
										<div class="col-2">
											<img class="retina_logo" src="assets/img/logo.PNG" alt="spa lab" title="" style="width: 50px;" />
										</div>
					...
					<div class="container">
						...
						<section id="primary" class="page-with-sidebar with-right-sidebar">
							...
							<div class="column dt-sc-one-half first">
								...
								<select name="services" class="dt-select-service">
									<option value="Brushing Cheveux Court">Brushing Cheveux Court </option>
									<option value="Brushing Cheveux Long">Brushing Cheveux Long</option>
									<option value="Coloration">Coloration</option>
									<option value="Soin Cheveux">Soin Cheveux</option>
									<option value="Coupe Cheveux">Coupe Cheveux</option>
									<option value="Soin TANINO">Soin TANINO</option>
									<option value="Soin KLEVER">Soin KLEVER</option>
									<option value="Soin COSMETICA">Soin COSMETICA</option>
									<option value="Duvet Et Sourcils">Duvet Et Sourcils</option>
									<option value="EPILATION JAMBE">EPILATION JAMBE</option>
									<option value="EPILATION JAMBE">EPILATION COMPLETE</option>
									<option value="EPILATION JAMBE">Soin Visage</option>
									<option value="EPILATION JAMBE">MANICURE </option>
									<option value="EPILATION JAMBE">Microblading</option>
									<option value="EPILATION JAMBE">GLACAGE LEVRE</option>
									<option value="EPILATION JAMBE">SHADOING</option>
									<option value="EPILATION JAMBE">GLACAGE LEVRE</option>
									<option value="EPILATION JAMBE">MAKE UP Leger</option>
									<option value="EPILATION JAMBE">MAKE UP</option>
								</select>
							</div>
							...
							<div class="column dt-sc-one-half">
								...
								<select name="staff" class="dt-select-staff">
									...
									<option value="Fatima zohra">Fatima zohra</option>
							...
							<div class="column dt-sc-one-half first">
								<p>Nom et Prénom </p>
								<input type="text" placeholder="Nom et Prénom " name="fullName" value="" required="">
							</div>

							<div class="column dt-sc-one-half">
								<p>Téléphone </p>
								<input type="text" placeholder="06 xx xx xx xx " name="phone" value="" required="">
							</div>

							<div class="dt-sc-hr-invisible-small"> </div>
							<div class="clear"> </div>
							<h5 class="hr-title dark-title"><span>Time</span></h5>
							<div class="hr-invisible-very-small"> </div>
							<div class="clear"> </div>

							<div class="column dt-sc-one-fourth first">
								<p>Je suis disponible sur : </p>
								<p>
								<input type="text" id="datepicker" name="dateDispo" value="2021-01-27" /></p>

							</div>

							<div class="column dt-sc-three-fourth">
								<div class="column dt-sc-one-half first">
									<p>Début :</p><select name="startTime" class='start-time'>
								...
								<div class="column dt-sc-one-half">
									<p>- Fin :</p><select name="endTime" class='end-time'>
										<option value="09:00">9:00 am</option>
										<option value="10:00">10:00 am</option>
										<option value="11:00">11:00 am</option>
										<option value="12:00">12:00 pm</option>
										...
										<option value="22:00">10:00 pm</option>
										<option value="23:00">11:00 pm</option>
										<option value="23:59" selected="selected">12:00 am</option>
									</select>
								</div>
							</div>
							<div class="clear"></div>
							<input class="btn btn-primary" value="Réserver" name="Réserver" type="submit" style="float: left;" />
							<div class="hr-invisible-very-small"> </div>
							<div class="clear"> </div>
						...
						<section id="secondary" class="">
							<aside id="text-19" class="widget widget_text">
								<h3 class="widgettitle">Pourquoi nous choisir</h3>
								<div class="textwidget">Vous serez 100% chouchouter et relaxer.
									<div class="hr-invisible-very-small"></div>
									<div class="clear"></div>
									<a class="ad-promobox" href="#"><img src="https://spalabdev.wpengine.com/wp-content/uploads/2014/09/promo2-large.jpg" alt="promo2-large"></a>
								</div>
							</aside>
